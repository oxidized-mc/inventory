# Contributing to oxidized-inventory
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/inventory.git
cd inventory
...
`oxidized-inventory` is a library crate in the
...
Use `inventory` as the scope for all changes to this crate.
